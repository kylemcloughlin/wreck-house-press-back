...
class CategorizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorization" do
    assert_difference('Categorization.count') do
      post categorizations_url, params: { categorization: { name: @categorization.name } }, as: :json
    end
  ...
  test "should update categorization" do
    patch categorization_url(@categorization), params: { categorization: { name: @categorization.name } }, as: :json
    assert_response 200
  end
