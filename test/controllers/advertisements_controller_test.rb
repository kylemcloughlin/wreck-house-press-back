...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { img: @advertisement.img, link: @advertisement.link, publish: @advertisement.publish, visable: @advertisement.visable } }, as: :json
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { img: @advertisement.img, link: @advertisement.link, publish: @advertisement.publish, visable: @advertisement.visable } }, as: :json
    assert_response 200
  end
